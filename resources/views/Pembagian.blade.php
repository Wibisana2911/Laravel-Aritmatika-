...
<div class="min-w-screen min-h-screen bg-gray-900 flex items-center justify-center px-5 py-5">
    <div behavior="alternate" class="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" style="max-width:1000px">
        <div class="md:flex w-full">
            <div class="hidden md:block w-1/2 bg-[conic-gradient(at_right,_var(--tw-gradient-stops))] from-gray-700 via-rose-600 to-cyan-800 py-10 px-10  ">
            <h1 class="font-bold text-3xl mt-52 text-black text-center ">PEMBAGIAN ( ÷ )</h1>
            </div>
